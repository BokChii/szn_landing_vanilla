export default {
    ...
    "questions": [
        {
            "id": 1,
            "text": "주말 아침, 웹툰 앱을 켰을 때 가장 먼저 눈길이 가는 썸네일은?",
            "options": [
                {
                    "text": "따뜻한 햇살 아래 웃고 있는 주인공들",
                    "scores": {
                        "slice": 1
                    }
                },
                {
                    "text": "화려한 검술이나 초능력을 쓰는 역동적인 모습",
                    "scores": {
                        "action": 1,
                        "martial_arts": 1
                    }
                ...
                {
                    "text": "묘한 분위기를 풍기는 두 남녀의 눈맞춤",
                    "scores": {
                        "romance": 1
                    }
                },
                {
                    "text": "거대한 성이나 신비로운 마법이 펼쳐진 배경",
                    "scores": {
                        "fantasy": 1
                    }
                }
        ...
        {
            "id": 3,
            "text": "웹툰을 보다가 '심쿵' 혹은 '소름' 돋는 순간은 언제야?",
            "options": [
                {
                    "text": "전혀 예상치 못한 범인이 밝혀지는 순간",
                    "scores": {
                        "thriller": 1
                    }
                },
                {
                    "text": "꽉 막혔던 고구마 전개가 한 방에 해결될 때",
                    "scores": {
                        "action": 1,
                        "martial_arts": 1
                    }
                ...
                {
                    "text": "주인공들 사이의 미묘한 기류가 폭발할 때",
                    "scores": {
                        "romance": 1
                    }
                },
                {
                    "text": "방대한 세계관의 비밀이 하나씩 풀릴 때",
                    "scores": {
                        "fantasy": 1
                    }
                }
        ...
        {
            "id": 4,
            "text": "내가 가장 선호하는 이야기의 전개 속도는?",
            "options": [
                {
                    "text": "느긋하게 흘러가며 소소한 재미를 주는 속도",
                    "scores": {
                        "slice": 1
                    }
                },
                {
                    "text": "숨 쉴 틈 없이 휘몰아치는 전개",
                    "scores": {
                        "action": 2
                    }
                },
                {
                    "text": "빌드업을 차곡차곡 쌓아 마지막에 터뜨리는 속도",
                    "scores": {
                        "thriller": 1,
                        "fantasy": 1
                    }
        ...
        {
            "id": 5,
            "text": "웹툰 속 주인공이 위기에 처했을 때, 내가 바라는 전개는?",
            "options": [
                {
                    "text": "동료들과의 우정과 사랑으로 극복한다",
                    "scores": {
                        "romance": 1,
                        "slice": 1
                    }
                ...
                {
                    "text": "화려한 컨트롤과 타격감으로 적을 제압한다",
                    "scores": {
                        "action": 1
                    }
                },
                {
                    "text": "단서를 조합해 함정에서 빠져나온다",
                    "scores": {
                        "thriller": 1
                    }
                }
        ...
        {
            "id": 6,
            "text": "마지막 화를 보고 난 후, 어떤 기분이 드는 웹툰이 좋아?",
            "options": [
                {
                    "text": "마음이 몽글몽글해지고 힐링 되는 기분",
                    "scores": {
                        "slice": 1,
                        "romance": 1
                    }
                ...
                {
                    "text": "땀을 쥐게 하던 긴장이 풀리며 느끼는 카타르시스",
                    "scores": {
                        "thriller": 1,
                        "action": 1
                    }
